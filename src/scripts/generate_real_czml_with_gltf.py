...
OUT_FILE = os.path.abspath(os.path.join(current_dir, "..", "..", "public", "real_starlink_orbit_with_gltf.czml"))
...
def main():
    ...
    for i, sat in enumerate(satellites):
        ...
        entity_node = {
            ...
            # ================= 新增：强行给所有节点挂载 glTF 模型 =================
            "model": {
                "gltf": "/models/Satellite.gltf",  # 注意：这里改成你 public 文件夹下的真实模型路径
                "scale": 1.0,
                "minimumPixelSize": 30             # 保证远距离也能看见模型，方便压测时观察
            },
            # ======================================================================
            "path": {
